            ...
            <div class="row">
               ...
               <div class="col-lg-12 animated fadeInRight impact-panel" style="margin-top: 0">
                  ...
                  <div class="groupWrapper clearfix">
                      ...
                      <div class="addGroup clearfix"><h2>Add Group <a href="{{url('volunteer/group/group_add')}}"><i class="fa fa-plus-circle"></i></a></h2></div>
                                ...
                                @endif
                                   ...
                                   <div class="vlWrapper">
                                       ...
                                       @if($lists->role_id==1)
                                        ...
                                        <a class="btn btn-primary" href="{{url('volunteer/group/group_add/'.$lists->id)}}">Edit Group</a>

                                        

                                       @else

                                         <a onclick="return confirm('Are you sure to leave ?')" class="btn btn-primary" href="{{url('volunteer/leave_group/'.$lists->id)}}">Leave Group</a>
                                        ...
                                        <div id="members{{$key}}" class="tab-pane fade">
                                          ...
                                          @if($lists->role_id==1)
                                            ...
                                            <div class="col-lg-6">
                                              ...
                                              <div class="input-group" data-id="{{$lists->id}}">

                                                <input type="text" name="invite_name" style="height:38px;" class="form-control invite_name" placeholder="Type name to invite">
        ...
        $('.invite_name').keyup(function(){
          ...
          {//alert($(this).val().length);
            ...
            $.ajax({
              ...
              url: "{{ url('/api/volunteer/group/get_user') }}",
