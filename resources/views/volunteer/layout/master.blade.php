    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav nav-menu">
                ...
                <li <?php if($page_name == 'org_home'){ ?>class="active" <?php } ?>><a class="page-scroll" href="{{url('/organization/')}}"><i class="fa fa-home"></i>Home</a></li>



                <li <?php if($page_name == 'org_profile'){ ?>class="active" <?php } ?>><a class="page-scroll" href="{{url('/organization/profile')}}"><i class="fa fa-user"></i>Profile</a></li>



                <li <?php if($page_name == 'org_oppor'){ ?>class="active" <?php } ?>><a class="page-scroll" href="{{url('/organization/opportunity')}}"><i class="fa fa-globe"></i>Opportunities</a></li>



                <li <?php if($page_name == 'org_track'){ ?>class="active" <?php } ?>><a class="page-scroll" href="{{url('/organization/track')}}"><i class="fa fa-line-chart"></i>Track</a></li>



                <li <?php if($page_name == 'org_friend'){ ?>class="active" <?php } ?>><a class="page-scroll" href="{{url('/organization/friend')}}"><i class="fa fa-user-plus"></i>Friends</a></li>



                <li <?php if($page_name == 'org_group'){ ?>class="active" <?php } ?>><a class="page-scroll" href="{{url('/organization/group')}}"><i class="fa fa-group"></i>Groups</a></li>

				 <li <?php if($page_name == 'impact'){ ?>class="active" <?php } ?>><a class="page-scroll" href="{{url('/organization/impact')}}"><i class="fa fa-pie-chart"></i>Impact</a></li>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                            ...
                            <div class="text-center link-block">
                                ...
                                <div class="search-box">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="search_box" class="form-control" placeholder="People,group,org,opportunities"> <span class="input-group-btn">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li>
							...
							<a href="{{url('/organization/profile')}}" class="pull-left">



                                    <img alt="image" class="img-circle" <?php if(Auth::user()->logo_img == NULL){ ?>src="<?=asset('front-end/img/org/001.png') ?>" <?php }else{ ?> src="<?=asset('uploads') ?>/{{Auth::user()->logo_img}}" <?php }?>>
                                ...
                                <div class="user-name">{{Auth::user()->org_name}}</div>
                                ...
                                <div class="profile-button clearfix text-center">



                                    <a href="{{url('/organization/profile')}}" class="btn btn-primary">
                ...
                <li class="dropdown">
                    ...
                    <a class="dropdown-toggle count-info" title="Post Opportunity" href="{{url('organization/post_opportunity')}}">
                ...
                <li class="dropdown">
                    ...
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" data-placement="bottom" title="Messages Box" href="#">
                        ...
                        <i class="fa fa-envelope"></i>  <span class="label label-warning" style="display: none"></span>
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li>
                            ...
                            <div class="dropdown-user-box">
							  ...
							  <a href="{{url('/volunteer/profile')}}" class="pull-left">
                                ...
                                <div class="profile-button clearfix text-center">
                                    ...
                                    <a href="{{url('/volunteer/accountSetting')}}" class="btn btn-primary pull-right">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.copy-right').html('<strong>&copy; '+n+' MyVoluntier Operations, LLC</strong>');
