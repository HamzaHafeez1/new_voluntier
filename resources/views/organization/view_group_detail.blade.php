            ...
            <div class="row">
                <div class="col-lg-12 animated fadeInRight profile-panel">
                    ...
                    <div class="col-lg-4 profile-view-logo">
                        ...
                        <div class="content">
                            <img <?php if($group_info['org_logo'] == NULL){ ?>src="<?=asset('front-end/img/org/001.png') ?>" <?php }else{ ?> src="<?=asset('uploads') ?>/{{$group_info['org_logo']}} <?php }?>" class="img-circle circle-border m-b-md" alt="profile">
                                                            ...
                                                            <td style="text-align: left; padding-left: 20px">
                                                                <a href="{{url('/profile')}}/{{$mi['member_id']}}" target="_blank">
                                                                    @if($mi['member_logo'] == null)
                                                                        <img alt="image" class="img-circle" src="<?=asset('front-end/img/org/001.png')?>"> <strong>{{$mi['member_name']}}</strong>
                                                                    @else
