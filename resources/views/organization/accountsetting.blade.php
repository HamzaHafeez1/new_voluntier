                        ...
                        <div class="profile-image">
                            <form id="upload_logo" role="form" method="post" action="{{url('api/organization/profile/upload_logo')}}" enctype="multipart/form-data">
                                ...
                                <div class="profile-image-hover">
                                    <img <?php if(Auth::user()->logo_img == NULL){ ?>src="<?=asset('front-end/img/org/001.png') ?>" <?php }else{ ?> src="<?=asset('uploads') ?>/{{Auth::user()->logo_img}}" <?php }?> class="img-circle circle-border m-b-md" alt="profile">
...
@section('script')
  <script language="javascript" type="text/javascript">
        ...
        $("#org_summary").bind("paste keydown", function(e) {
            var value = $(this).val();
            value += " ";
